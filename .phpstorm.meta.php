...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\ProgramacionIIIUTN\tienda-mascota\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\ProgramacionIIIUTN\\tienda-mascota\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'sanctum.csrf-cookie','articulos.index','articulos.store','articulos.show','articulos.update',
'articulos.destroy','categorias.index','categorias.store','categorias.show','categorias.update',
'categorias.destroy','clientes.index','clientes.store','clientes.show','clientes.update',
'clientes.destroy','provincias.index','provincias.importar','clientes.index','clientes.create',
'clientes.store','clientes.show','clientes.edit','clientes.update','clientes.destroy',
'storage.local',);
        registerArgumentsSet('views', 
'clientes.create','clientes.edit','clientes.index','clientes.show','layouts.app',
'mascotas.create','pokemon.error','pokemon.list','pokemon.notfound','pokemon.show',
'provincias.index','tratamiento.create','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'DB_PASSWORD','BROADCAST_CONNECTION','FILESYSTEM_DISK','QUEUE_CONNECTION','CACHE_STORE',
